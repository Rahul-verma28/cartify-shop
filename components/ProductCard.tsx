...
export default function ProductCard({
  ...
  return (
    <motion.div
      ...
      className="group"
    >
      <Card className="overflow-hidden h-full flex flex-col border-none shadow-none bg-transparent">
        <Link href={`/products/${product?.slug}`} className="block">
          <div className="relative aspect-square rounded-md overflow-hidden bg-gray-100 dark:bg-gray-900">
            <Image
              src={
